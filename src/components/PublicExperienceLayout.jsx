  ...
  return (
    <div className="lex-public-page">
      <style>{`
        ...
        .lex-public-footer{border-top:1px solid var(--line);padding:20px;color:#7A8699;text-align:center;font-size:11px;background:#fff}.lex-public-footer a{color:var(--navy2);text-decoration:none;font-weight:700}
