...
export default function ReportsV2() {
  ...
  return <div className="lex-reports-v2">
    ...
    <section className="lex-report-hero">
      ...
      <h1>Reports, analysis and visualisation</h1>
    ...
    <section className="lex-report-filters">
      <div className="lex-report-filter-head"><div style={{ display: 'flex', alignItems: 'center', gap: 7, fontSize: 12, fontWeight: 800 }}><Filter size={15} /> Refine report</div><button onClick={resetFilters} style={{ display: 'flex', gap: 5, alignItems: 'center', border: 0, background: 'transparent', fontSize: 12, color: 'var(--color-navy-700)' }}><RotateCcw size={13} /> Reset</button></div>
