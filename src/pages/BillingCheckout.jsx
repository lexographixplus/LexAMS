...
const eyebrow = { display: 'inline-flex', alignItems: 'center', gap: 6, color: '#a56d00', background: '#fff3d5', borderRadius: 99, padding: '6px 9px', fontSize: 12, fontWeight: 800, letterSpacing: '.08em' };
