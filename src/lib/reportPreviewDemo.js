...
export const reportPreviewDemo = {
  activities: [
    { id: -8101, title: 'Youth Digital Skills Bootcamp', type: 'Training', status: 'Completed', venue: 'Community Learning Centre', organizer: 'LexAMS Demo Workspace', facilitator: 'Ebrima Njie and Awa Ceesay', start_date: '2026-08-03', end_date: '2026-08-07', sessions: 3, reg_open: false, reg_token: 'preview-bootcamp-registration', att_token: 'preview-bootcamp-checkin', description: 'A practical multi-day digital skills training for youth leaders.' },
