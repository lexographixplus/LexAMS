...
export default function ActivityOperationsPanel() {
  ...
  return (
    <section className="lexops-shell">
      <style>{`
        .lexops-shell{max-width:1240px;margin:0 auto 22px;border:1px solid var(--border-default);border-radius:18px;background:var(--surface-card);box-shadow:0 14px 36px rgba(0,43,84,.06);overflow:hidden}.lexops-loading{padding:24px;color:var(--text-secondary);font-size:13px}.lexops-head{padding:18px 20px;display:flex;justify-content:space-between;gap:18px;align-items:flex-start;background:linear-gradient(135deg,#002B54,#0E4C8F);color:white;border-bottom:4px solid #FAB72D}.lexops-head h2{margin:2px 0 0;font-family:var(--font-display);font-size:21px}.lexops-kicker{font-size:12px;letter-spacing:.1em;text-transform:uppercase;font-weight:800;opacity:.72}.lexops-head-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.lexops-head button{border-color:rgba(255,255,255,.28)!important;color:white!important;background:rgba(255,255,255,.08)!important}.lexops-primary,.lexops-secondary,.lexops-icon{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:38px;padding:0 12px;border-radius:9px;font-size:12px;font-weight:750;cursor:pointer}.lexops-primary{border:0;background:var(--color-gold-500);color:var(--color-navy-900)}.lexops-secondary{border:1px solid var(--border-default);background:var(--surface-card);color:var(--color-navy-700)}.lexops-icon{width:38px;padding:0;border:1px solid var(--border-default);background:transparent;color:var(--color-navy-700)}.lexops-summary{display:grid;grid-template-columns:repeat(5,1fr);border-bottom:1px solid var(--border-default)}.lexops-summary>div{padding:14px 16px;border-right:1px solid var(--border-default)}.lexops-summary>div:last-child{border-right:0}.lexops-summary span{display:block;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:var(--text-tertiary);font-weight:800}.lexops-summary strong{display:block;margin-top:5px;font-family:var(--font-display);font-size:20px;color:var(--color-navy-900)}.lexops-body{padding:18px;display:grid;gap:18px}.lexops-section{border:1px solid var(--border-default);border-radius:13px;overflow:hidden}.lexops-section-head{padding:13px 15px;display:flex;justify-content:space-between;gap:12px;align-items:center;border-bottom:1px solid var(--border-default);background:var(--surface-muted)}.lexops-section-head h3{font-size:13px;margin:0;color:var(--color-navy-900)}.lexops-section-head p{font-size:12px;margin:3px 0 0;color:var(--text-tertiary)}.lexops-sessions{display:flex;gap:9px;padding:12px;overflow-x:auto}.lexops-session-card{min-width:190px;text-align:left;padding:12px;border:1px solid var(--border-default);border-radius:10px;background:var(--surface-card);cursor:pointer}.lexops-session-card.active{border-color:var(--color-navy-700);box-shadow:0 0 0 2px rgba(14,76,143,.08)}.lexops-session-title{font-weight:800;font-size:12px;color:var(--text-primary)}.lexops-session-meta{font-size:12px;color:var(--text-tertiary);margin-top:5px}.lexops-session-foot{display:flex;justify-content:space-between;align-items:center;margin-top:10px}.lexops-live-grid{display:grid;grid-template-columns:1.35fr .65fr;gap:16px;padding:15px}.lexops-live-left{min-width:0}.lexops-tools{display:grid;grid-template-columns:minmax(220px,1fr) 150px;gap:8px;margin-bottom:10px}.lexops-search{position:relative}.lexops-search svg{position:absolute;left:11px;top:50%;transform:translateY(-50%);color:var(--text-tertiary)}.lexops-search input{padding-left:34px!important}.lexops-filter-row{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px}.lexops-filter-row button{border:1px solid var(--border-default);background:var(--surface-card);border-radius:999px;padding:6px 9px;font-size:12px;font-weight:750;color:var(--text-secondary);cursor:pointer}.lexops-filter-row button.active{background:var(--color-navy-900);color:white;border-color:var(--color-navy-900)}.lexops-roster{border:1px solid var(--border-default);border-radius:10px;overflow:hidden;max-height:430px;overflow-y:auto}.lexops-person{display:grid;grid-template-columns:minmax(180px,1.5fr) .8fr auto;gap:10px;align-items:center;padding:10px 11px;border-bottom:1px solid var(--border-default)}.lexops-person:last-child{border-bottom:0}.lexops-person-name{font-size:12px;font-weight:800}.lexops-person-meta{font-size:12px;color:var(--text-tertiary);margin-top:3px}.lexops-status-actions{display:flex;gap:4px;flex-wrap:wrap;justify-content:flex-end}.lexops-status-actions button{border:1px solid var(--border-default);border-radius:7px;background:var(--surface-card);padding:5px 7px;font-size:12px;font-weight:800;cursor:pointer;color:var(--text-secondary)}.lexops-status-actions button.selected{background:var(--color-navy-900);border-color:var(--color-navy-900);color:white}.lexops-live-side{border-left:1px solid var(--border-default);padding-left:16px}.lexops-qr-wrap{display:grid;justify-items:center;gap:9px}.lexops-linkbox{display:flex;align-items:center;gap:7px;width:100%;border:1px solid var(--border-default);background:var(--surface-muted);border-radius:8px;padding:7px 8px;box-sizing:border-box}.lexops-linkbox span{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;color:var(--text-tertiary)}.lexops-side-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;width:100%}.lexops-pin{padding:10px;border-radius:9px;background:#FFF6DF;text-align:center}.lexops-pin span{display:block;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#8A5A00;font-weight:800}.lexops-pin strong{display:block;margin-top:3px;font-size:21px;color:#6B4300;letter-spacing:.08em}.lexops-scan{margin-top:12px}.lexops-scan label{display:block;font-size:12px;font-weight:800;color:var(--text-tertiary);margin-bottom:5px}.lexops-reg-tabs{display:flex;gap:6px}.lexops-reg-list{padding:0}.lexops-reg-row{display:grid;grid-template-columns:minmax(190px,1fr) 130px 110px auto;gap:12px;align-items:center;padding:10px 14px;border-bottom:1px solid var(--border-default)}.lexops-reg-row:last-child{border-bottom:0}.lexops-reg-actions{display:flex;gap:5px;justify-content:flex-end}.lexops-empty-small{padding:18px;color:var(--text-tertiary);font-size:12px;text-align:center}.lexops-error{padding:12px 14px;background:#FBEAEA;color:#A42C27;font-size:12px}.lexops-queue{display:inline-flex;align-items:center;gap:6px;padding:6px 9px;border-radius:999px;background:#FFF6DF;color:#8A5A00;font-size:12px;font-weight:800;cursor:pointer;border:0}.lexops-modal-backdrop,.lexops-poster-backdrop{position:fixed;inset:0;z-index:500;background:rgba(0,43,84,.42);display:grid;place-items:center;padding:20px;overflow-y:auto}.lexops-modal{width:min(680px,100%);max-height:90vh;overflow:auto;background:var(--surface-card);border-radius:16px;box-shadow:0 28px 80px rgba(0,43,84,.24);padding:22px}.lexops-modal-large{width:min(820px,100%)}.lexops-modal-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.lexops-modal-head h3{margin:3px 0 0;font-family:var(--font-display);font-size:21px}.lexops-form-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:17px}.lexops-form-grid label>span,.lexops-custom-row+span{display:block;font-size:12px;color:var(--text-tertiary);font-weight:800;margin-bottom:5px}.lexops-form-grid .wide{grid-column:1/-1}.lexops-modal-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:20px}.lexops-settings-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:17px}.lexops-toggle{display:flex;gap:9px;padding:11px;border:1px solid var(--border-default);border-radius:9px}.lexops-toggle input{margin-top:2px}.lexops-toggle strong,.lexops-toggle small{display:block}.lexops-toggle strong{font-size:12px}.lexops-toggle small{font-size:12px;color:var(--text-tertiary);margin-top:3px;line-height:1.4}.lexops-custom-head{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-top:20px}.lexops-custom-head strong,.lexops-custom-head small{display:block}.lexops-custom-head strong{font-size:12px}.lexops-custom-head small{font-size:12px;color:var(--text-tertiary);margin-top:2px}.lexops-custom-list{display:grid;gap:8px;margin-top:9px}.lexops-custom-row{display:grid;grid-template-columns:1.5fr .8fr auto auto;gap:7px;align-items:center}.lexops-custom-row .wide{grid-column:1/-1}.lexops-inline-check{display:flex;align-items:center;gap:5px;font-size:12px;color:var(--text-secondary)}.lexops-poster{position:relative;width:min(520px,100%);background:white;border-radius:16px;padding:34px;text-align:center;color:#122033;box-shadow:0 28px 80px rgba(0,43,84,.24)}.lexops-poster-close{position:absolute;right:13px;top:13px;border:0;background:#EEF3F8;border-radius:8px;width:34px;height:34px;display:grid;place-items:center;color:#002B54}.lexops-print-kicker{font-size:12px;text-transform:uppercase;letter-spacing:.14em;color:#0E4C8F;font-weight:900}.lexops-poster h2{font-family:Georgia,serif;font-size:29px;color:#002B54;margin:8px 0}.lexops-poster p{color:#687587;line-height:1.55}.lexops-poster-qr{display:grid;place-items:center;margin:22px 0}.lexops-poster-pin{display:inline-block;background:#FFF6DF;padding:9px 18px;border-radius:10px;margin-bottom:12px}.lexops-poster-pin span{display:block;font-size:12px;text-transform:uppercase;color:#8A5A00;font-weight:800}.lexops-poster-pin strong{display:block;font-size:24px;color:#6B4300;letter-spacing:.1em}.lexops-poster-url{font-size:12px;color:#8A96A5;overflow-wrap:anywhere;margin:8px 0 18px}.lexops-toast{position:fixed;right:20px;bottom:20px;z-index:800;background:#002B54;color:white;padding:10px 14px;border-radius:9px;font-size:12px;font-weight:700;box-shadow:0 10px 28px rgba(0,43,84,.25)}@media(max-width:900px){.lexops-summary{grid-template-columns:repeat(3,1fr)}.lexops-live-grid{grid-template-columns:1fr}.lexops-live-side{border-left:0;border-top:1px solid var(--border-default);padding:16px 0 0}.lexops-reg-row{grid-template-columns:1fr 1fr}.lexops-reg-actions{justify-content:flex-start}}@media(max-width:620px){.lexops-head{flex-direction:column}.lexops-head-actions{justify-content:flex-start}.lexops-summary{grid-template-columns:1fr 1fr}.lexops-summary>div{border-bottom:1px solid var(--border-default)}.lexops-tools{grid-template-columns:1fr}.lexops-person{grid-template-columns:1fr}.lexops-status-actions{justify-content:flex-start}.lexops-reg-row{grid-template-columns:1fr}.lexops-form-grid,.lexops-settings-grid{grid-template-columns:1fr}.lexops-form-grid .wide{grid-column:auto}.lexops-custom-row{grid-template-columns:1fr}.lexops-custom-row .wide{grid-column:auto}}@media print{body *{visibility:hidden!important}.lexops-poster,.lexops-poster *{visibility:visible!important}.lexops-poster-backdrop{position:absolute;inset:0;background:white;padding:0}.lexops-poster{position:absolute;left:50%;top:20px;transform:translateX(-50%);box-shadow:none;width:520px;max-width:calc(100% - 40px)}.lexops-no-print,.lexops-poster-close{display:none!important}}
      `}</style>
      ...
      <div className="lexops-body">
          ...
          <section className="lexops-section">
            ...
            <div className="lexops-live-grid">
              ...
              <aside className="lexops-live-side">
                ...
                <div className="lexops-scan"><label>SCAN PASS / ENTER REFERENCE</label><input ref={scanRef} style={inputStyle} placeholder="PASS:… or REG-…" onKeyDown={e => { if (e.key === 'Enter') { e.preventDefault(); processScan(e.currentTarget.value); } }} /><div style={{ fontSize: 12, lineHeight: 1.45, color: 'var(--text-tertiary)', marginTop: 5 }}>Works with USB/Bluetooth QR scanners that type the scanned value, or manual registration references.</div></div>
              </aside>
            </div>
          </section>
        )}
        ...
        <section className="lexops-section">
          ...
          <div className="lexops-reg-list">
            {registrationRows.map(reg => <div className="lexops-reg-row" key={reg.id}><div><div className="lexops-person-name">{reg.name}</div><div className="lexops-person-meta">{reg.email}{reg.org ? ` · ${reg.org}` : ''}</div></div><div style={{ fontSize: 12, color: 'var(--text-secondary)', fontWeight: 700 }}>{reg.reference_code}</div><StatusBadge status={reg.status} /><div className="lexops-reg-actions">{reg.status !== 'confirmed' && reg.status !== 'cancelled' && <button className="lexops-primary" onClick={() => mutate('set_registration_status', { registrationId: reg.id, status: 'confirmed' }, 'Registration confirmed')}><Check size={13} /> Confirm</button>}{reg.status !== 'cancelled' && <button className="lexops-secondary" onClick={() => mutate('set_registration_status', { registrationId: reg.id, status: 'cancelled' }, 'Registration cancelled')}>Cancel</button>}{reg.status === 'cancelled' && <button className="lexops-secondary" onClick={() => mutate('set_registration_status', { registrationId: reg.id, status: 'confirmed' }, 'Registration restored')}>Restore</button>}</div></div>)}
