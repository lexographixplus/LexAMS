  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        }}>Start managing activities, participants, and certificates.</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Horizon Community Foundation"
                style={inputStyle}
                onFocus={e => e.target.style.borderColor = 'var(--color-navy-700)'}
                onBlur={e => e.target.style.borderColor = 'var(--border-default)'}
              />
        ...
        <div style={{
          ...
          <Link to="/login" style={{ fontWeight: 600, color: 'var(--color-navy-700)' }}>
            Sign in
          </Link>
        </div>
      </div>
