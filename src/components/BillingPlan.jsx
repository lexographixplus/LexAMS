...
function Meter({ label, current, limit }) {
  ...
  return <div style={{ marginTop: 13 }}>
    ...
    {warning && <div style={{ marginTop: 5, color: percent >= 100 ? 'var(--color-danger)' : '#8A5A00', fontSize: 12, fontWeight: 700 }}>{warning}</div>}
  </div>;
}
...
const eyebrow = { color: 'var(--text-tertiary)', fontSize: 12, letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 700 };
...
const documentLink = { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: 30, padding: '6px 9px', border: '1px solid var(--border-default)', borderRadius: 'var(--radius-sm)', background: 'var(--surface-card)', color: 'var(--color-navy-800)', fontSize: 12, fontWeight: 700, textDecoration: 'none' };
