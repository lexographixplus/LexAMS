...
export const reportPreviewDemo = {
  activities: [
    { id: -8101, title: 'Youth Digital Skills Bootcamp', type: 'Training', status: 'Completed', venue: 'Community Learning Centre', organizer: 'LexAMS Demo Workspace', facilitator: 'Ebrima Njie and Awa Ceesay', start_date: '2026-08-03', end_date: '2026-08-21', sessions: 6, reg_open: false, reg_token: 'preview-bootcamp-registration', att_token: 'preview-bootcamp-checkin', description: 'A practical three-week digital skills training for youth leaders.' },
    { id: -8102, title: 'Community Leadership Workshop', type: 'Workshop', status: 'Completed', venue: 'Civic Resource Hub', organizer: 'LexAMS Demo Workspace', facilitator: 'Neneh Sowe', start_date: '2026-08-12', end_date: '2026-08-13', sessions: 2, reg_open: false, reg_token: 'preview-leadership-registration', att_token: 'preview-leadership-checkin', description: 'A collaborative workshop on inclusive leadership and community action.' },
    { id: -8103, title: 'Monitoring & Evaluation Clinic', type: 'Clinic', status: 'Completed', venue: 'Programme Support Centre', organizer: 'LexAMS Demo Workspace', facilitator: 'Mariama Sanyang', start_date: '2026-08-18', end_date: '2026-08-19', sessions: 2, reg_open: false, reg_token: 'preview-me-registration', att_token: 'preview-me-checkin', description: 'A focused clinic for strengthening programme monitoring and evidence use.' },
  ],
  participants: [
